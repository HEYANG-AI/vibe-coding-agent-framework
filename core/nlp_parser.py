...
class NLPParser:
    def __init__(self):
        self.intent_keywords = {
            Intent.NAVIGATE: ["前往", "打开", "导航", "进入", "访问", "去"],
            Intent.LOGIN: ["登录", "登陆", "登入", "登录系统", "登录平台"],
            Intent.NEW_AGENT: ["新建", "创建", "新的", "新增", "建智能体", "建agent", "建立"],
            Intent.LIST_AGENTS: ["查看", "列表", "已有", "查看列表", "浏览", "列表查看"],
            Intent.BUILD_WORKFLOW: ["搭建", "创建", "构建", "做工作流", "画", "画工作流", "画布"],
            Intent.PUBLISH: ["发布", "上线", "保存发布", "部署", "发布上线"],
            Intent.FULL_FLOW: ["完整流程", "全流程", "全部", "自动", "全自动", "一句话", "跑通"],
            Intent.EXIT: ["退出", "关闭", "结束", "退出关闭", "安全退出"]
        }
